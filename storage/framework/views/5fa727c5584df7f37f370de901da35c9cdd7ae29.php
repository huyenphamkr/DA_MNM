  ...
  <div class="col-12" >
    <!-- Main content -->
      <div class="row no-print" style="margin: 10px 0px">
        <div class="col-4">
          <a href="<?php echo e(url('admin/warehouse/orders/list')); ?>">
          ...
          <a href="<?php echo e(url('admin/warehouse/orders/print/'.$order->id.'')); ?>"  id="print" rel="noopener" target="_blank">
...
<?php echo $__env->make('admin.warehouse.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\PTPMMNM\DA_MNM\resources\views/admin/warehouse/orders/show.blade.php ENDPATH**/ ?>