...
<div class="row">
  <div class="col-12" >
      <div class="row no-print" style="margin: 10px 0px">
        <div class="col-4">
          <a href="<?php echo e(url('admin/purchase/list')); ?>">
          ...
          <a href="<?php echo e(url('admin/purchase/print/'.$purchase->id.'')); ?>"  id="print" rel="noopener" target="_blank">
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\PTPMMNM\DA_MNM\resources\views/admin/purchase/show.blade.php ENDPATH**/ ?>