          ...
          <tbody>
              ...
              <?php $__currentLoopData = $orderslist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $orders): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr style="text-align: center">
                  ...
                  <td >
                    <a class="btn btn-primary btn-sm" href="<?php echo e(url('admin/warehouse/orders/show/'.$orders->id.'')); ?>">
                      <i class="fas fa-eye"></i>
                    </a>
                    <a class="btn btn-primary btn-sm" target="_blank"  href="<?php echo e(url('admin/warehouse/orders/print/'.$orders->id.'')); ?>" style="background-color: green; border-color: green;">
...
$(document).ready(function() {
  ...
  $.ajax({
    url: "<?php echo e(route('warehousefilter')); ?>",
    method: "GET",
    data: {
          'show' : $show,
      },      
...
<?php echo $__env->make('admin.warehouse.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\PTPMMNM\DA_MNM\resources\views/admin/warehouse/orders/list.blade.php ENDPATH**/ ?>