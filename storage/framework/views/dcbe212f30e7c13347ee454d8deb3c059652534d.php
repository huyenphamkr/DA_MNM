                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                <?php if(Route::has('ForgetPass')): ?>
                                    <a class="btn btn-link" href="<?php echo e(route('ForgetPass')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\PTPMMNM\DA_MNM\resources\views/admin/users/login.blade.php ENDPATH**/ ?>