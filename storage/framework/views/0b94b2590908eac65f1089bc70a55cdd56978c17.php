        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo e(route('postregister')); ?>">
                        <?php echo csrf_field(); ?>

                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Họ tên')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="phone_number" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Số điện thoại')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="gender" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Giới tính')); ?></label>
                        ...
                        <div class="row mb-3">
                            <label for="address" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Địa chỉ')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="address" value="<?php echo e(old('address')); ?>" required autocomplete="phone_number" autofocus>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\PTPMMNM\DA_MNM\resources\views/admin/users/register.blade.php ENDPATH**/ ?>