      ...
      <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" aria-describedby="example2_info">
        ...
        <tr>
          ...
          <td><?php echo e($supplier->name); ?></td>
              ...
              <td style="text-align: center;">
                  <a class="btn btn-primary btn-sm" href="<?php echo e(url('admin/supplier/edit/'.$supplier->id.'')); ?>">
                      <i class="fas fa-edit"></i>
                  </a>
                  <a class="btn btn-danger btn-sm" href="<?php echo e(url('admin/supplier/destroy/'.$supplier->id.'')); ?>">
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\PTPMMNM\DA_MNM\resources\views/admin/supplier/list.blade.php ENDPATH**/ ?>