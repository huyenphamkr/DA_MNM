                      ...
                      <tbody>
                        <?php $__currentLoopData = $purchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr class="odd" style="text-align: center">
                            ...
                            <td >
                              <a class="btn btn-primary btn-sm" href="<?php echo e(url('admin/purchase/show/'.$purchase->id.'')); ?>">
                                <i class="fas fa-eye"></i>
                              </a>
                              <a class="btn btn-primary btn-sm"  href="<?php echo e(url('admin/purchase/print/'.$purchase->id.'')); ?>" target="_blank" style="background-color: green; border-color: green;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\PTPMMNM\DA_MNM\resources\views/admin/purchase/list.blade.php ENDPATH**/ ?>