        ...
        <div class="d-none flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between">
            <div>
                <p class="small text-muted">
                    ...
                    <?php echo __('trong số'); ?>

                    <span class="fw-semibold"><?php echo e($paginator->total()); ?></span>
                    <?php echo __('kết quả:'); ?> <?php echo e($paginator->currentPage()); ?>

                    <input type="hidden" value = "<?php echo e(old('page', $paginator->currentPage())); ?>" name="page" id="page">
                </p>
            </div>
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\PTPMMNM\DA_MNM\resources\views/vendor/pagination/bootstrap-5.blade.php ENDPATH**/ ?>