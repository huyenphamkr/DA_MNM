                  ...
                  <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                      <thead>
                        <tr role="row" style="text-align: center">                      
                          ...
                          <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Khách hàng</th>
                      ...
                      <tbody>
                        @foreach($orders as $key => $order)
                          <tr class="odd" style="text-align: center">
                            <td>{{ $key+1}}</td>
                            <td class="sorting_1 dtr-control">{{ $order->id }}</td>
                            ...
                            <td>{{date_format(date_create($order->date),"H:i:s")}}</td> 
                            <td>{{ number_format($order->total, 0, ',', '.')}} VND</td> 
                            <td> 
                              <a class="btn btn-primary btn-sm" href="{{ url('admin/orders/show/'.$order->id.'') }}">
                                <i class="fas fa-eye"></i>
                              </a>
                              <a class="btn btn-primary btn-sm"  href="{{ url('admin/orders/print/'.$order->id.'') }}" target="_blank" style="background-color: green; border-color: green;">
