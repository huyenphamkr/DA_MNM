            ...
            {{-- Khởi tạo vòng lập foreach lấy giá trị vào bảng--}}
              @foreach($products as $key => $product)
                <tr>
                  ...
                  <td style="text-align: center">
                    <a class="btn btn-primary btn-sm" href="{{ url('admin/warehouse/product/edit/'.$product->id.'') }}">
                      <i class="fas fa-edit"></i>
                    </a>
                    <a class="btn btn-danger btn-sm" href="{{ url('admin/warehouse/product/destroy/'.$product->id.'') }}">
