                      ...
                      <tbody>
                        @foreach($purchases as $key => $purchase)
                          <tr class="odd" style="text-align: center">
                            ...
                            <td >
                              <a class="btn btn-primary btn-sm" href="{{ url('admin/warehouse/purchase/show/'.$purchase->id.'') }}">
                                <i class="fas fa-eye"></i>
                              </a>
                              <a class="btn btn-primary btn-sm"  href="{{ url('admin/warehouse/purchase/print/'.$purchase->id.'') }}" target="_blank" style="background-color: green; border-color: green;">
