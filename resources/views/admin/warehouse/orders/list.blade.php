            ...
            {{-- Khởi tạo vòng lập foreach lấy giá trị vào bảng--}}
              @foreach($orderslist as $key => $orders)
                <tr style="text-align: center">
                  ...
                  <td >
                    <a class="btn btn-primary btn-sm" href="{{ url('admin/warehouse/orders/show/'.$orders->id.'') }}">
                      <i class="fas fa-eye"></i>
                    </a>
                    <a class="btn btn-primary btn-sm" target="_blank"  href="{{ url('admin/warehouse/orders/print/'.$orders->id.'') }}" style="background-color: green; border-color: green;">
