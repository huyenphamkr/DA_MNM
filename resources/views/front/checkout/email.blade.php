                ...
                <div class="container-fluid">
                    ...
                    <div class="row mt-5" style="margin-top: 35px; display: flex;">
                        <div class="col-6"
                            ...
                            <br>
                            <span>
                                <a style="color: white !important;" href="mailto:{{ $user->email }}" target="_blank">{{ $user->email }}</a>
                            </span>
                            <br>
                            ...
                            {{-- @foreach($order->orderDetails as $orderDetail) --}}
                                <tr>
                                    <td style="border-top: 1px solid #dee2e6; padding: 5px 0;">
                                        {{ $orderDetail->name . ' (x' . $orderDetail->pivot->quantity . ')'}}
                                    </td>
                                    <td style="border-top: 1px solid #dee2e6; padding: 5px 20px 5px 0; text-align: right;">
                                        {{ number_format($orderDetail->pivot->price*$orderDetail->pivot->quantity, 0, ',', '.')}} VND
                        ...
                        <div class="col-12 p-0">
                            ...
                            <table class="mt-2 w-100"
                                ...
                                <tr>
                                    ...
                                    <td class="pr-3 text-right" style="text-align: right; padding-right: 20px;">
                                        {{number_format(str_replace(',', '', number_format(str_replace(',', '', $subtotal))), 0, ',', '.')}} VND
                                    </td>
                                </tr>
                                <tr style="font-size: 18px;">
                                    <td><b>Tổng tiền</b></td>
                                    <td class="pr-3 text-right" style="text-align: right; padding-right: 20px;">
                                        <b>{{number_format(str_replace(',', '', number_format(str_replace(',', '', $total))), 0, ',', '.')}} VND</b>
                                    </td>
                                </tr>
                            </table>
                        </div>
