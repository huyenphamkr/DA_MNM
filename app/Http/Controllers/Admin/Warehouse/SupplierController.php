...
class SupplierController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.warehouse.supplier.list',[
    ...
    {    
        ...
        return redirect('admin/warehouse/supplier/add');
    }

    public function create()
    {
        return view('admin.warehouse.supplier.add',[
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/warehouse/supplier/list');//
    }
    ...
    {
        $supplier = Supplier::find($id);
        return view('admin.warehouse.supplier.edit',[
