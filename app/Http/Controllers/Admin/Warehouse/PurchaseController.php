...
class PurchaseController extends Controller
{
    ...
    {        
        ...
        return view('admin.warehouse.purchase.list',[
    ...
    public function show($id)
    {
        ...
        return view('admin.warehouse.purchase.show',[
    ...
    {    
        ...
        $employees = Purchases::where('id','=',$id)->with('user')->get();
        $purchases = Purchases::where('id','=',$id)->with('products')->get();
        return view('admin.warehouse.purchase.print',[
            'title'=>'Purchase #'.$id,
            'purchases'=>$purchases,
            'suppliers'=>$suppliers,
            'employees'=>$employees,
    ...
    { 
        ...
        return view('admin.warehouse.purchase.add',[
    ...
    public function store()
    {
        ...
        return redirect('admin/warehouse/purchase/add');
    }
}